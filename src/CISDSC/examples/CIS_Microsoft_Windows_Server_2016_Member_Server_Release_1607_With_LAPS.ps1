...
Configuration Microsoft_Windows_Server_2016_Member_Server_1607_CIS_L1_with_LAPS
{
...
Microsoft_Windows_Server_2016_Member_Server_1607_CIS_L1_with_LAPS
Start-DscConfiguration -Path '.\Microsoft_Windows_Server_2016_Member_Server_1607_CIS_L1_with_LAPS' -Verbose -Wait
