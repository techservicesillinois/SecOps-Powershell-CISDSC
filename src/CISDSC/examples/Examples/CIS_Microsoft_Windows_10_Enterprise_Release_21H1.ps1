...
Configuration Microsoft_Windows_10_Enterprise_21H1_CIS_L1
{
...
Microsoft_Windows_10_Enterprise_21H1_CIS_L1
Start-DscConfiguration -Path '.\Microsoft_Windows_10_Enterprise_21H1_CIS_L1' -Verbose -Wait
