...
<#
    .DESCRIPTION
    Applies CIS Level one benchmarks for Microsoft Windows Server 2019 Member Server build 20H2 with no exclusions.
...
Configuration Microsoft_Windows_Server_2019_Member_Server_20H2_CIS_L1_with_LAPS
{
...
Microsoft_Windows_Server_2019_Member_Server_20H2_CIS_L1_with_LAPS
Start-DscConfiguration -Path '.\Microsoft_Windows_Server_2019_Member_Server_20H2_CIS_L1_with_LAPS' -Verbose -Wait
