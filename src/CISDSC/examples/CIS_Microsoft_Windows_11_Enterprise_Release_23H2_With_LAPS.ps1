...
Configuration Microsoft_Windows_11_Enterprise_23H2_CIS_L1_with_LAPS
{
...
Microsoft_Windows_11_Enterprise_23H2_CIS_L1_with_LAPS
Start-DscConfiguration -Path '.\Microsoft_Windows_11_Enterprise_23H2_CIS_L1_with_LAPS' -Verbose -Wait
