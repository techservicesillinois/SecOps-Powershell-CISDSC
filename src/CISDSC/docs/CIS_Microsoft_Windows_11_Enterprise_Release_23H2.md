---
date: 1/31/2024
keywords: dsc,powershell,configuration,setup,cis,security,23H2
title: CIS_Microsoft_Windows_11_Enterprise_Release_23H2
---

# DSC CIS*Microsoft_Windows_11_Enterprise\_Release*23H2 Resource

> Applies To: Windows PowerShell 5.1 and higher

The **CIS*Microsoft_Windows_11_Enterprise\_Release*23H2** resource in Windows PowerShell Desired State Configuration (DSC) provides a
mechanism to apply CIS benchmarks on a target node running Microsoft Windows 11 Enterprise release 23H2.

## Syntax

```Syntax
CIS_Microsoft_Windows_11_Enterprise_Release_23H2 [String] #ResourceName
{
    [ ExcludeList = [String[]] ]
    [ LevelOne = [Boolean] ]
    [ LevelTwo = [Boolean] ]
    ...
    [ cis124Resetaccountlockoutcounterafter = [Int32] { 15-99999 } ]
    [ cis18102612MaxSize = [Int32] { 32768-2147483647 } ]
    [ cis18102622MaxSize = [Int32] { 196608-2147483647 } ]
    [ cis18102632MaxSize = [Int32] { 32768-2147483647 } ]
    [ cis18102642MaxSize = [Int32] { 32768-2147483647 } ]
    [ cis1810573101MaxIdleTime = [Int32] { 60000-900000 } ]
    [ cis18109342DeferFeatureUpdatesPeriodInDays = [Int32] { 180-365 } ]
    [ cis1835PasswordLength = [Int32] { 15-64 } ]
    [ cis1836PasswordAgeDays = [Int32] { 30-365 } ]
    [ cis18510ScreenSaverGracePeriod = [String] { '0' | '1' | '2' | '3' | '4' | '5' } ]
    [ cis18513WarningLevel = [Int32] { 0-90 } ]
    [ cis2314AccountsRenameadministratoraccount = [String] { 1-256 } ]
    [ cis2315AccountsRenameguestaccount = [String] { 1-256 } ]
...
> `2314AccountsRenameadministratoraccount`,
> `2315AccountsRenameguestaccount`,
...
|cis124Resetaccountlockoutcounterafter |15 |1.2.4 |(L1) Ensure 'Reset account lockout counter after' is set to '15 or more minute(s)' |
|cis18102612MaxSize |32768 |18.10.26.1.2 |(L1) Ensure 'Application: Specify the maximum log file size (KB)' is set to 'Enabled: 32,768 or greater' |
|cis18102622MaxSize |196608 |18.10.26.2.2 |(L1) Ensure 'Security: Specify the maximum log file size (KB)' is set to 'Enabled: 196,608 or greater' |
|cis18102632MaxSize |32768 |18.10.26.3.2 |(L1) Ensure 'Setup: Specify the maximum log file size (KB)' is set to 'Enabled: 32,768 or greater' |
|cis18102642MaxSize |32768 |18.10.26.4.2 |(L1) Ensure 'System: Specify the maximum log file size (KB)' is set to 'Enabled: 32,768 or greater' |
|cis1810573101MaxIdleTime |900000 |18.10.57.3.10.1 |(L2) Ensure 'Set time limit for active but idle Remote Desktop Services sessions' is set to 'Enabled: 15 minutes or less, but not Never (0)' |
|cis18109342DeferFeatureUpdatesPeriodInDays |180 |18.10.93.4.2 |(L1) Ensure 'Select when Preview Builds and Feature Updates are received' is set to 'Enabled: 180 or more days' |
|cis1835PasswordLength |15 |18.3.5 |(L1) Ensure 'Password Settings: Password Length' is set to 'Enabled: 15 or more' |
|cis1836PasswordAgeDays |30 |18.3.6 |(L1) Ensure 'Password Settings: Password Age (Days)' is set to 'Enabled: 30 or fewer' |
|cis18510ScreenSaverGracePeriod |'0' |18.5.10 |(L1) Ensure 'MSS: (ScreenSaverGracePeriod) The time in seconds before the screen saver grace period expires (0 recommended)' is set to 'Enabled: 5 or fewer seconds' |
|cis18513WarningLevel |90 |18.5.13 |(L1) Ensure 'MSS: (WarningLevel) Percentage threshold for the security event log at which the system will generate a warning' is set to 'Enabled: 90% or less' |
|cis2314AccountsRenameadministratoraccount | |2.3.1.4 |(L1) Configure 'Accounts: Rename administrator account' |
|cis2315AccountsRenameguestaccount | |2.3.1.5 |(L1) Configure 'Accounts: Rename guest account' |
...
Configuration MyConfiguration
{
    ...
    CIS_Microsoft_Windows_11_Enterprise_Release_23H2 'CISBenchmarks'
    {
