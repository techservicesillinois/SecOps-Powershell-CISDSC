...
The **CIS_Microsoft_Windows_10_Enterprise_Release_20H2** resource in Windows PowerShell Desired State Configuration (DSC) provides a
mechanism to apply CIS benchmarks on a target node running Microsoft Windows 10 Enterprise release 20H2.

## Syntax

```Syntax
CIS_Microsoft_Windows_10_Enterprise_Release_20H2 [String] #ResourceName
{
    [ ExcludeList = [String[]] ]
    [ LevelOne = [Boolean] ]
    [ LevelTwo = [Boolean] ]
