Configuration CIS_Microsoft_Windows_10_Enterprise_Release_21H1
{
    param
    (
        [String[]]$ExcludeList = @(),
        ...
        [Int32]$cis18910312DeferFeatureUpdatesPeriodInDays = 180,
        ...
        [Int32]$cis189633101MaxIdleTime = 900000,
    ...
    if($ExcludeList -notcontains '18.9.11.1.1' -and $BitLocker){
        Registry "18.9.11.1.1 - (BL) Ensure Allow access to BitLocker-protected fixed data drives from earlier versions of Windows is set to Disabled (1)" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueData = '<none>'
        ...
        Registry "18.9.11.1.1 - (BL) Ensure Allow access to BitLocker-protected fixed data drives from earlier versions of Windows is set to Disabled (2)" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueData = 0
    ...
    if($ExcludeList -notcontains '18.9.11.1.10' -and $BitLocker){
        Registry "18.9.11.1.10 - (BL) Ensure Configure use of hardware-based encryption for fixed data drives is set to Disabled (1)" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueData = 0
        ...
        Registry "18.9.11.1.10 - (BL) Ensure Configure use of hardware-based encryption for fixed data drives is set to Disabled (2)" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueData = 0
        ...
        Registry "18.9.11.1.10 - (BL) Ensure Configure use of hardware-based encryption for fixed data drives is set to Disabled (3)" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueData = 0
        ...
        Registry "18.9.11.1.10 - (BL) Ensure Configure use of hardware-based encryption for fixed data drives is set to Disabled (4)" {
            Ensure = 'Absent'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
    ...
    if($ExcludeList -notcontains '18.9.11.1.11' -and $BitLocker){
        Registry "18.9.11.1.11 - (BL) Ensure Configure use of passwords for fixed data drives is set to Disabled (1)" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueData = 0
        ...
        Registry "18.9.11.1.11 - (BL) Ensure Configure use of passwords for fixed data drives is set to Disabled (2)" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueData = 0
        ...
        Registry "18.9.11.1.11 - (BL) Ensure Configure use of passwords for fixed data drives is set to Disabled (3)" {
            Ensure = 'Absent'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueName = 'FDVPassphraseComplexity'
        }
        Registry "18.9.11.1.11 - (BL) Ensure Configure use of passwords for fixed data drives is set to Disabled (4)" {
            Ensure = 'Absent'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
    ...
    if($ExcludeList -notcontains '18.9.11.1.12' -and $BitLocker){
        Registry "18.9.11.1.12 - (BL) Ensure Configure use of smart cards on fixed data drives is set to Enabled" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueData = 1
    ...
    if($ExcludeList -notcontains '18.9.11.1.13' -and $BitLocker){
        Registry "18.9.11.1.13 - (BL) Ensure Configure use of smart cards on fixed data drives Require use of smart cards on fixed data drives is set to Enabled True" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueData = 1
    ...
    if($ExcludeList -notcontains '18.9.11.2.11' -and $BitLocker){
        Registry "18.9.11.2.11 - (BL) Ensure Configure use of hardware-based encryption for operating system drives is set to Disabled (1)" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueData = 0
        ...
        Registry "18.9.11.2.11 - (BL) Ensure Configure use of hardware-based encryption for operating system drives is set to Disabled (2)" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueData = 0
        ...
        Registry "18.9.11.2.11 - (BL) Ensure Configure use of hardware-based encryption for operating system drives is set to Disabled (3)" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueData = 0
        ...
        Registry "18.9.11.2.11 - (BL) Ensure Configure use of hardware-based encryption for operating system drives is set to Disabled (4)" {
            Ensure = 'Absent'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
    ...
    if($ExcludeList -notcontains '18.9.11.2.12' -and $BitLocker){
        Registry "18.9.11.2.12 - (BL) Ensure Configure use of passwords for operating system drives is set to Disabled (1)" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueData = 0
        ...
        Registry "18.9.11.2.12 - (BL) Ensure Configure use of passwords for operating system drives is set to Disabled (2)" {
            Ensure = 'Absent'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueName = 'OSPassphraseComplexity'
        }
        Registry "18.9.11.2.12 - (BL) Ensure Configure use of passwords for operating system drives is set to Disabled (3)" {
            Ensure = 'Absent'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueName = 'OSPassphraseLength'
        }
        Registry "18.9.11.2.12 - (BL) Ensure Configure use of passwords for operating system drives is set to Disabled (4)" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueData = 0
    ...
    if($ExcludeList -notcontains '18.9.11.2.13' -and $BitLocker){
        Registry "18.9.11.2.13 - (BL) Ensure Require additional authentication at startup is set to Enabled (1)" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueData = 1
        ...
        Registry "18.9.11.2.13 - (BL) Ensure Require additional authentication at startup is set to Enabled (2)" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueData = 2
            ValueName = 'UseTPM'
        ...
        Registry "18.9.11.2.13 - (BL) Ensure Require additional authentication at startup is set to Enabled (3)" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueData = 2
            ValueName = 'UseTPMPIN'
        ...
        Registry "18.9.11.2.13 - (BL) Ensure Require additional authentication at startup is set to Enabled (4)" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueData = 2
            ValueName = 'UseTPMKey'
        ...
        Registry "18.9.11.2.13 - (BL) Ensure Require additional authentication at startup is set to Enabled (5)" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueData = 2
        ...
        Registry "18.9.11.2.13 - (BL) Ensure Require additional authentication at startup is set to Enabled (6)" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueData = 0
        ...
        Registry "18.9.11.2.13 - (BL) Ensure Require additional authentication at startup is set to Enabled (7)" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueData = 0
        ...
        Registry "18.9.11.2.13 - (BL) Ensure Require additional authentication at startup is set to Enabled (8)" {
            Ensure = 'Absent'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
    ...
    if($ExcludeList -notcontains '18.9.11.2.14' -and $BitLocker){
        Registry "18.9.11.2.14 - (BL) Ensure Require additional authentication at startup Allow BitLocker without a compatible TPM is set to Enabled False" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueData = 0
    ...
    if($ExcludeList -notcontains '18.9.11.3.10' -and $BitLocker){
        Registry "18.9.11.3.10 - (BL) Ensure Configure use of hardware-based encryption for removable data drives is set to Disabled" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueData = 0
    ...
    if($ExcludeList -notcontains '18.9.11.3.11' -and $BitLocker){
        Registry "18.9.11.3.11 - (BL) Ensure Configure use of passwords for removable data drives is set to Disabled (1)" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueData = 0
        ...
        Registry "18.9.11.3.11 - (BL) Ensure Configure use of passwords for removable data drives is set to Disabled (2)" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueData = 0
        ...
        Registry "18.9.11.3.11 - (BL) Ensure Configure use of passwords for removable data drives is set to Disabled (3)" {
            Ensure = 'Absent'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueName = 'RDVPassphraseComplexity'
        }
        Registry "18.9.11.3.11 - (BL) Ensure Configure use of passwords for removable data drives is set to Disabled (4)" {
            Ensure = 'Absent'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
    ...
    if($ExcludeList -notcontains '18.9.11.3.12' -and $BitLocker){
        Registry "18.9.11.3.12 - (BL) Ensure Configure use of smart cards on removable data drives is set to Enabled" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueData = 1
    ...
    if($ExcludeList -notcontains '18.9.11.3.13' -and $BitLocker){
        Registry "18.9.11.3.13 - (BL) Ensure Configure use of smart cards on removable data drives Require use of smart cards on removable data drives is set to Enabled True" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueData = 1
    ...
    if($ExcludeList -notcontains '18.9.11.3.14' -and $BitLocker){
        Registry "18.9.11.3.14 - (BL) Ensure Deny write access to removable drives not protected by BitLocker is set to Enabled" {
            Ensure = 'Present'
    ...
    if($ExcludeList -notcontains '18.9.11.3.15' -and $BitLocker){
        Registry "18.9.11.3.15 - (BL) Ensure Deny write access to removable drives not protected by BitLocker Do not allow write access to devices configured in another organization is set to Enabled False" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\FVE'
            ValueData = 0
    ...
    if($ExcludeList -notcontains '18.9.55.1' -and $LevelTwo){
        Registry "18.9.55.1 - (L2) Ensure Enable news and interests on the taskbar is set to Disabled" {
            Ensure = 'Present'
    ...
    if($ExcludeList -notcontains '18.9.56.1' -and $LevelOne){
        Registry "18.9.56.1 - (L1) Ensure Prevent the usage of OneDrive for file storage is set to Enabled" {
            Ensure = 'Present'
    ...
    if($ExcludeList -notcontains '18.9.62.1' -and $LevelTwo){
        Registry "18.9.62.1 - (L2) Ensure Turn off Push To Install service is set to Enabled" {
            Ensure = 'Present'
    ...
    if($ExcludeList -notcontains '18.9.63.2.2' -and $LevelOne){
        Registry "18.9.63.2.2 - (L1) Ensure Do not allow passwords to be saved is set to Enabled" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Terminal Services'
            ValueData = 1
    ...
    if($ExcludeList -notcontains '18.9.63.3.2.1' -and $LevelTwo){
        Registry "18.9.63.3.2.1 - (L2) Ensure Allow users to connect remotely by using Remote Desktop Services is set to Disabled" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\Windows NT\Terminal Services'
            ValueData = 1
    ...
    if($ExcludeList -notcontains '18.9.63.3.3.1' -and $LevelTwo){
        Registry "18.9.63.3.3.1 - (L2) Ensure Do not allow COM port redirection is set to Enabled" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\Windows NT\Terminal Services'
            ValueData = 1
    ...
    if($ExcludeList -notcontains '18.9.63.3.3.2' -and $LevelOne){
        Registry "18.9.63.3.3.2 - (L1) Ensure Do not allow drive redirection is set to Enabled" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Terminal Services'
            ValueData = 1
    ...
    if($ExcludeList -notcontains '18.9.63.3.3.3' -and $LevelTwo){
        Registry "18.9.63.3.3.3 - (L2) Ensure Do not allow LPT port redirection is set to Enabled" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\Windows NT\Terminal Services'
            ValueData = 1
    ...
    if($ExcludeList -notcontains '18.9.63.3.3.4' -and $LevelTwo){
        Registry "18.9.63.3.3.4 - (L2) Ensure Do not allow supported Plug and Play device redirection is set to Enabled" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\Windows NT\Terminal Services'
            ValueData = 1
    ...
    if($ExcludeList -notcontains '18.9.63.3.9.1' -and $LevelOne){
        Registry "18.9.63.3.9.1 - (L1) Ensure Always prompt for password upon connection is set to Enabled" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Terminal Services'
            ValueData = 1
    ...
    if($ExcludeList -notcontains '18.9.63.3.9.2' -and $LevelOne){
        Registry "18.9.63.3.9.2 - (L1) Ensure Require secure RPC communication is set to Enabled" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Terminal Services'
            ValueData = 1
    ...
    if($ExcludeList -notcontains '18.9.63.3.9.3' -and $LevelOne){
        Registry "18.9.63.3.9.3 - (L1) Ensure Require use of specific security layer for remote (RDP) connections is set to Enabled SSL" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Terminal Services'
            ValueData = 2
    ...
    if($ExcludeList -notcontains '18.9.63.3.9.4' -and $LevelOne){
        Registry "18.9.63.3.9.4 - (L1) Ensure Require user authentication for remote connections by using Network Level Authentication is set to Enabled" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Terminal Services'
            ValueData = 1
    ...
    if($ExcludeList -notcontains '18.9.63.3.9.5' -and $LevelOne){
        Registry "18.9.63.3.9.5 - (L1) Ensure Set client connection encryption level is set to Enabled High Level" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Terminal Services'
            ValueData = 3
    ...
    if($ExcludeList -notcontains '18.9.63.3.10.1' -and $LevelTwo){
        Registry "18.9.63.3.10.1 - (L2) Ensure Set time limit for active but idle Remote Desktop Services sessions is set to Enabled 15 minutes or less but not Never (0)" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\Windows NT\Terminal Services'
            ValueData = $cis189633101MaxIdleTime
            ValueName = 'MaxIdleTime'
            ValueType = 'Dword'
        }
    }
    if($ExcludeList -notcontains '18.9.63.3.10.2' -and $LevelTwo){
        Registry "18.9.63.3.10.2 - (L2) Ensure Set time limit for disconnected sessions is set to Enabled 1 minute" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\Windows NT\Terminal Services'
            ValueData = 60000
    ...
    if($ExcludeList -notcontains '18.9.63.3.11.1' -and $LevelOne){
        Registry "18.9.63.3.11.1 - (L1) Ensure Do not delete temp folders upon exit is set to Disabled" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Terminal Services'
            ValueData = 1
    ...
    if($ExcludeList -notcontains '18.9.64.1' -and $LevelOne){
        Registry "18.9.64.1 - (L1) Ensure Prevent downloading of enclosures is set to Enabled" {
            Ensure = 'Present'
    ...
    if($ExcludeList -notcontains '18.9.65.2' -and $LevelTwo){
        Registry "18.9.65.2 - (L2) Ensure Allow Cloud Search is set to Enabled Disable Cloud Search" {
            Ensure = 'Present'
    ...
    if($ExcludeList -notcontains '18.9.65.3' -and $LevelOne){
        Registry "18.9.65.3 - (L1) Ensure Allow Cortana is set to Disabled" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\Windows Search'
            ValueData = 0
    ...
    if($ExcludeList -notcontains '18.9.65.4' -and $LevelOne){
        Registry "18.9.65.4 - (L1) Ensure Allow Cortana above lock screen is set to Disabled" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\Windows Search'
            ValueData = 0
    ...
    if($ExcludeList -notcontains '18.9.65.5' -and $LevelOne){
        Registry "18.9.65.5 - (L1) Ensure Allow indexing of encrypted files is set to Disabled" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\Windows Search'
            ValueData = 0
    ...
    if($ExcludeList -notcontains '18.9.65.6' -and $LevelOne){
        Registry "18.9.65.6 - (L1) Ensure Allow search and Cortana to use location is set to Disabled" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\Windows Search'
            ValueData = 0
    ...
    if($ExcludeList -notcontains '18.9.70.1' -and $LevelTwo){
        Registry "18.9.70.1 - (L2) Ensure Turn off KMS Client Online AVS Validation is set to Enabled" {
            Ensure = 'Present'
    ...
    if($ExcludeList -notcontains '18.9.73.1' -and $LevelTwo){
        Registry "18.9.73.1 - (L2) Ensure Disable all apps from Microsoft Store is set to Disabled" {
            Ensure = 'Present'
    ...
    if($ExcludeList -notcontains '18.9.73.2' -and $LevelOne){
        Registry "18.9.73.2 - (L1) Ensure Only display the private store within the Microsoft Store is set to Enabled" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\WindowsStore'
            ValueData = 1
    ...
    if($ExcludeList -notcontains '18.9.73.3' -and $LevelOne){
        Registry "18.9.73.3 - (L1) Ensure Turn off Automatic Download and Install of updates is set to Disabled" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\WindowsStore'
            ValueData = 4
    ...
    if($ExcludeList -notcontains '18.9.73.4' -and $LevelOne){
        Registry "18.9.73.4 - (L1) Ensure Turn off the offer to update to the latest version of Windows is set to Enabled" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\WindowsStore'
            ValueData = 1
    ...
    if($ExcludeList -notcontains '18.9.73.5' -and $LevelTwo){
        Registry "18.9.73.5 - (L2) Ensure Turn off the Store application is set to Enabled" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\WindowsStore'
            ValueData = 1
    ...
    if($ExcludeList -notcontains '18.9.81.1.1' -and $LevelOne){
        Registry "18.9.81.1.1 - (L1) Ensure Configure Windows Defender SmartScreen is set to Enabled Warn and prevent bypass (1)" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\System'
            ValueData = 1
        ...
        Registry "18.9.81.1.1 - (L1) Ensure Configure Windows Defender SmartScreen is set to Enabled Warn and prevent bypass (2)" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\System'
            ValueData = 'Block'
    ...
    if($ExcludeList -notcontains '18.9.81.2.1' -and $LevelOne){
        Registry "18.9.81.2.1 - (L1) Ensure Configure Windows Defender SmartScreen is set to Enabled" {
            Ensure = 'Present'
    ...
    if($ExcludeList -notcontains '18.9.81.2.2' -and $LevelOne){
        Registry "18.9.81.2.2 - (L1) Ensure Prevent bypassing Windows Defender SmartScreen prompts for sites is set to Enabled" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\MicrosoftEdge\PhishingFilter'
            ValueData = 1
    ...
    if($ExcludeList -notcontains '18.9.83.1' -and $LevelOne){
        Registry "18.9.83.1 - (L1) Ensure Enables or disables Windows Game Recording and Broadcasting is set to Disabled" {
            Ensure = 'Present'
    ...
    if($ExcludeList -notcontains '18.9.85.1' -and $LevelTwo){
        Registry "18.9.85.1 - (L2) Ensure Allow suggested apps in Windows Ink Workspace is set to Disabled" {
            Ensure = 'Present'
    ...
    if($ExcludeList -notcontains '18.9.85.2' -and $LevelOne){
        Registry "18.9.85.2 - (L1) Ensure Allow Windows Ink Workspace is set to Enabled On but disallow access above lock OR Disabled but not Enabled On" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\WindowsInkWorkspace'
            ValueData = 1
    ...
    if($ExcludeList -notcontains '18.9.86.1' -and $LevelOne){
        Registry "18.9.86.1 - (L1) Ensure Allow user control over installs is set to Disabled" {
            Ensure = 'Present'
    ...
    if($ExcludeList -notcontains '18.9.86.2' -and $LevelOne){
        Registry "18.9.86.2 - (L1) Ensure Always install with elevated privileges is set to Disabled" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\Installer'
            ValueData = 0
    ...
    if($ExcludeList -notcontains '18.9.86.3' -and $LevelTwo){
        Registry "18.9.86.3 - (L2) Ensure Prevent Internet Explorer security prompt for Windows Installer scripts is set to Disabled" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\Windows\Installer'
            ValueData = 0
    ...
    if($ExcludeList -notcontains '18.9.87.1' -and $LevelOne){
        Registry "18.9.87.1 - (L1) Ensure Sign-in and lock last interactive user automatically after a restart is set to Disabled" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System'
            ValueData = 1
    ...
    if($ExcludeList -notcontains '18.9.96.1' -and $LevelOne){
        Registry "18.9.96.1 - (L1) Ensure Turn on PowerShell Script Block Logging is set to Disabled (1)" {
            Ensure = 'Present'
        ...
        Registry "18.9.96.1 - (L1) Ensure Turn on PowerShell Script Block Logging is set to Disabled (2)" {
            Ensure = 'Absent'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\PowerShell\ScriptBlockLogging'
            ValueName = 'EnableScriptBlockInvocationLogging'
        }
    }
    if($ExcludeList -notcontains '18.9.96.2' -and $LevelOne){
        Registry "18.9.96.2 - (L1) Ensure Turn on PowerShell Transcription is set to Disabled (1)" {
            Ensure = 'Present'
        ...
        Registry "18.9.96.2 - (L1) Ensure Turn on PowerShell Transcription is set to Disabled (2)" {
            Ensure = 'Absent'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\PowerShell\Transcription'
            ValueName = 'OutputDirectory'
        }
        Registry "18.9.96.2 - (L1) Ensure Turn on PowerShell Transcription is set to Disabled (3)" {
            Ensure = 'Absent'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\PowerShell\Transcription'
            ValueName = 'EnableInvocationHeader'
        }
    }
    if($ExcludeList -notcontains '18.9.98.1.1' -and $LevelOne){
        Registry "18.9.98.1.1 - (L1) Ensure Allow Basic authentication is set to Disabled" {
            Ensure = 'Present'
    ...
    if($ExcludeList -notcontains '18.9.98.1.2' -and $LevelOne){
        Registry "18.9.98.1.2 - (L1) Ensure Allow unencrypted traffic is set to Disabled" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WinRM\Client'
            ValueData = 0
    ...
    if($ExcludeList -notcontains '18.9.98.1.3' -and $LevelOne){
        Registry "18.9.98.1.3 - (L1) Ensure Disallow Digest authentication is set to Enabled" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WinRM\Client'
            ValueData = 0
    ...
    if($ExcludeList -notcontains '18.9.98.2.1' -and $LevelOne){
        Registry "18.9.98.2.1 - (L1) Ensure Allow Basic authentication is set to Disabled" {
            Ensure = 'Present'
    ...
    if($ExcludeList -notcontains '18.9.98.2.2' -and $LevelTwo){
        Registry "18.9.98.2.2 - (L2) Ensure Allow remote server management through WinRM is set to Disabled (1)" {
            Ensure = 'Present'
            Key = 'HKLM:\Software\Policies\Microsoft\Windows\WinRM\Service'
            ValueData = 0
        ...
        Registry "18.9.98.2.2 - (L2) Ensure Allow remote server management through WinRM is set to Disabled (2)" {
            Ensure = 'Absent'
            Key = 'HKLM:\Software\Policies\Microsoft\Windows\WinRM\Service'
            ValueName = 'IPv4Filter'
        }
        Registry "18.9.98.2.2 - (L2) Ensure Allow remote server management through WinRM is set to Disabled (3)" {
            Ensure = 'Absent'
            Key = 'HKLM:\Software\Policies\Microsoft\Windows\WinRM\Service'
            ValueName = 'IPv6Filter'
        }
    }
    if($ExcludeList -notcontains '18.9.98.2.3' -and $LevelOne){
        Registry "18.9.98.2.3 - (L1) Ensure Allow unencrypted traffic is set to Disabled" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WinRM\Service'
            ValueData = 0
            ValueName = 'AllowUnencryptedTraffic'
    ...
    if($ExcludeList -notcontains '18.9.98.2.4' -and $LevelOne){
        Registry "18.9.98.2.4 - (L1) Ensure Disallow WinRM from storing RunAs credentials is set to Enabled" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WinRM\Service'
            ValueData = 1
    ...
    if($ExcludeList -notcontains '18.9.99.1' -and $LevelTwo){
        Registry "18.9.99.1 - (L2) Ensure Allow Remote Shell Access is set to Disabled" {
            Ensure = 'Present'
    ...
    if($ExcludeList -notcontains '18.9.100.2.1' -and $LevelOne){
        Registry "18.9.100.2.1 - (L1) Ensure Prevent users from modifying settings is set to Enabled" {
            Ensure = 'Present'
    ...
    if($ExcludeList -notcontains '18.9.103.2' -and $LevelOne){
        Registry "18.9.103.2 - (L1) Ensure Configure Automatic Updates is set to Enabled (1)" {
            Ensure = 'Present'
        ...
        Registry "18.9.103.2 - (L1) Ensure Configure Automatic Updates is set to Enabled (2)" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\AU'
            ValueData = 3
            ValueName = 'AUOptions'
        ...
        Registry "18.9.103.2 - (L1) Ensure Configure Automatic Updates is set to Enabled (3)" {
            Ensure = 'Absent'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\AU'
            ValueName = 'AutomaticMaintenanceEnabled'
        }
        Registry "18.9.103.2 - (L1) Ensure Configure Automatic Updates is set to Enabled (4)" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\AU'
            ValueData = 1
        ...
        Registry "18.9.103.2 - (L1) Ensure Configure Automatic Updates is set to Enabled (5)" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\AU'
            ValueData = 1
        ...
        Registry "18.9.103.2 - (L1) Ensure Configure Automatic Updates is set to Enabled (6)" {
            Ensure = 'Absent'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\AU'
            ValueName = 'ScheduledInstallFirstWeek'
        }
        Registry "18.9.103.2 - (L1) Ensure Configure Automatic Updates is set to Enabled (7)" {
            Ensure = 'Absent'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\AU'
            ValueName = 'ScheduledInstallSecondWeek'
        }
        Registry "18.9.103.2 - (L1) Ensure Configure Automatic Updates is set to Enabled (8)" {
            Ensure = 'Absent'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\AU'
            ValueName = 'ScheduledInstallThirdWeek'
        }
        Registry "18.9.103.2 - (L1) Ensure Configure Automatic Updates is set to Enabled (9)" {
            Ensure = 'Absent'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\AU'
            ValueName = 'ScheduledInstallFourthWeek'
        }
        Registry "18.9.103.2 - (L1) Ensure Configure Automatic Updates is set to Enabled (10)" {
            Ensure = 'Absent'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\AU'
            ValueName = 'AllowMUUpdateService'
        }
    }
    if($ExcludeList -notcontains '18.9.103.3' -and $LevelOne){
        Registry "18.9.103.3 - (L1) Ensure Configure Automatic Updates Scheduled install day is set to 0 - Every day" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\AU'
            ValueData = 0
    ...
    if($ExcludeList -notcontains '18.9.103.4' -and $LevelOne){
        Registry "18.9.103.4 - (L1) Ensure No auto-restart with logged on users for scheduled automatic updates installations is set to Disabled" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\AU'
            ValueData = 0
    ...
    if($ExcludeList -notcontains '18.9.103.5' -and $LevelOne){
        Registry "18.9.103.5 - (L1) Ensure Remove access to Pause updates feature is set to Enabled" {
            Ensure = 'Present'
    ...
    if($ExcludeList -notcontains '18.9.103.1.1' -and $LevelOne){
        Registry "18.9.103.1.1 - (L1) Ensure Manage preview builds is set to Enabled Disable preview builds (1)" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate'
            ValueData = 1
        ...
        Registry "18.9.103.1.1 - (L1) Ensure Manage preview builds is set to Enabled Disable preview builds (2)" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate'
            ValueData = 0
    ...
    if($ExcludeList -notcontains '18.9.103.1.2' -and $LevelOne){
        Registry "18.9.103.1.2 - (L1) Ensure Select when Preview Builds and Feature Updates are received is set to Enabled Semi-Annual Channel 180 or more days (1)" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate'
            ValueData = 1
        ...
        Registry "18.9.103.1.2 - (L1) Ensure Select when Preview Builds and Feature Updates are received is set to Enabled Semi-Annual Channel 180 or more days (2)" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate'
            ValueData = 32
        ...
        Registry "18.9.103.1.2 - (L1) Ensure Select when Preview Builds and Feature Updates are received is set to Enabled Semi-Annual Channel 180 or more days (3)" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate'
            ValueData = $cis18910312DeferFeatureUpdatesPeriodInDays
            ValueName = 'DeferFeatureUpdatesPeriodInDays'
            ValueType = 'Dword'
        }
        Registry "18.9.103.1.2 - (L1) Ensure Select when Preview Builds and Feature Updates are received is set to Enabled Semi-Annual Channel 180 or more days (4)" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate'
            ValueData = 0
    ...
    if($ExcludeList -notcontains '18.9.103.1.3' -and $LevelOne){
        Registry "18.9.103.1.3 - (L1) Ensure Select when Quality Updates are received is set to Enabled 0 days (1)" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate'
            ValueData = 1
        ...
        Registry "18.9.103.1.3 - (L1) Ensure Select when Quality Updates are received is set to Enabled 0 days (2)" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate'
            ValueData = 0
        ...
        Registry "18.9.103.1.3 - (L1) Ensure Select when Quality Updates are received is set to Enabled 0 days (3)" {
            Ensure = 'Present'
            Key = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate'
            ValueData = 0
