@{
    ...
    GUID              = '637244a2-9e19-4e9d-8e66-babf20e63cff'
    ...
    RequiredModules   = @('ImportExcel', 'GPRegistryPolicyParser', 'Plaster')
    ...
    FunctionsToExport = ('ConvertTo-DSC','Get-CISBenchmarkValidWorksheets')
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'https://github.com/techservicesillinois/SecOps-Powershell-CISDSC/blob/main/CHANGELOG_CISDSCResourceGeneration.md'
